...
const ImageLinkForm = ({ onImageUrlChange, onSubmit }) => {
    return (
        <div className="flex flex-column">
            ...
            <div className="flex">
                <div className="form center pa4 br3 shadow-5">
                    ...
                    <button onClick={ onSubmit } className="w-30 center grow f4 link ph3 pv2 dib white bg-mid-gray ba b--mid-gray">Detect</button>
                </div>
            </div>
        </div>
    );
